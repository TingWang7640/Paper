...
% FISTA
para.ss=4;para.r=2;
    [x1,k1,t1, F1, SUDI1, a1]=FISTA_pow(x0,para,ProX,GradF,FvalF,FG_val);   
% FISTA_CD4
para.ss=4;para.r=4;
    [x2,k2,t2, F2, SUDI2, a2]=FISTA_pow(x0,para,ProX,GradF,FvalF,FG_val);
% FISTA_pow    
    para.ss=4;para.r=6;
...
legend('FISTA\_pow(2)','FISTA\_pow(4)','FISTA\_pow(6)','FISTA\_pow(8)')
